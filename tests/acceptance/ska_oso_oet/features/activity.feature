Scenario: Run an Activity, with SB retrieval from the ODA
    Given an SBDefinition sbd-mvp01-20200325-00011 exists in the ODA with script file:///tmp/scripts/success_with_sb.py in the allocate activity
...
Scenario: Run an Activity with the prepare_only flag, SB retrieval from the ODA
    Given an SBDefinition sbd-mvp01-20200325-00012 exists in the ODA with script file:///tmp/scripts/success_with_sb.py in the allocate activity
...
Scenario: Run an Activity, with script args that cause an error
    Given an SBDefinition sbd-mvp01-20200325-00013 exists in the ODA with script file:///tmp/scripts/success_with_sb.py in the allocate activity
