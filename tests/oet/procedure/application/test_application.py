...
def test_ses_summarise_returns_summaries_for_requested_pids():
    ...
    procedures.
    """
    procedure_a = Procedure('a')
    procedure_b = Procedure('b')
    procedure_c = Procedure('c')
    procedures = {1: procedure_a, 2: procedure_b, 3: procedure_c}

    expected = [
        create_empty_procedure_summary(1, 'a'),
        create_empty_procedure_summary(3, 'c')
    ]
...
def test_ses_summarise_returns_all_summaries_when_no_pid_requested():
    ...
    expected = [
        create_empty_procedure_summary(1, 'a'),
        create_empty_procedure_summary(2, 'b'),
        create_empty_procedure_summary(3, 'c')
    ]
